...
- Assignments waiting for an occupied workspace show **Queued** with the blocking assignment in Work and Mastermind context. Releasing that reservation starts the saved assignment automatically; interrupted work still requires inspection, cancellation or recovery before replacement.
