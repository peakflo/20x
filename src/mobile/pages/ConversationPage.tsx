      ...
      <div className="relative flex-1 min-h-0">
        ...
        >
          ...
          {messages.map((msg, index) => {
            ...
            return (
              <div
                // Key on the first member only: the trailing group grows as the
                // agent streams tool calls, and a key from all ids would change
                // per addition, remounting the group and losing expanded state.
                key={group[0].id}
                ref={(node) => {
