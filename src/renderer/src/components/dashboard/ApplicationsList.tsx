...
function ApplicationCard({
  ...
  return (
    <div
      className="rounded-lg border border-border/50 bg-[#191D23] p-4 cursor-pointer transition-all hover:border-border hover:bg-[#30353F] group"
      onClick={onClick}
    >
...
function ExpandedView() {
  ...
  return (
    <section className="flex flex-col" style={{ height: 'calc(100vh - 120px)' }}>
      ...
      <div className="flex items-center border-b border-border/50 shrink-0 bg-[#191D23] rounded-t-lg">
      ...
      <div className="flex-1 relative bg-[#191D23] rounded-b-lg overflow-hidden">
...
export function ApplicationsList() {
  ...
  if (applicationsLoading) {
    return (
      <section>
        <div className="rounded-lg border border-border/50 bg-[#191D23] p-6">
