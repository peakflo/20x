  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        recurrence_mode: { type: 'string', enum: ['reuse', 'separate'], description: 'Recurring schedules default to reuse: one task and workspace, with individual check history. Choose separate for a new task per occurrence. Reuse keeps the task open; auto-complete is disabled.' },
